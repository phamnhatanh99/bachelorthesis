...
public enum SimilarityMeasures {
    TABLE_NAME, COLUMN_NAME, COLUMN_VALUES, COLUMN_FORMAT;
    ...
    public static double getJoinWeight(SimilarityMeasures measure) {
        return switch (measure) {
            case TABLE_NAME -> TABLE_NAME_JOIN_WEIGHT;
            case COLUMN_NAME -> COLUMN_NAME_JOIN_WEIGHT;
            case COLUMN_VALUES -> COLUMN_VALUES_JOIN_WEIGHT;
    ...
    public static double getUnionWeight(SimilarityMeasures measure) {
        return switch (measure) {
            case TABLE_NAME -> TABLE_NAME_UNION_WEIGHT;
            case COLUMN_NAME -> COLUMN_NAME_UNION_WEIGHT;
            case COLUMN_VALUES -> COLUMN_VALUES_UNION_WEIGHT;
    ...
    public static void setJoinWeight(SimilarityMeasures measure, double weight) {
        switch (measure) {
            case TABLE_NAME -> TABLE_NAME_JOIN_WEIGHT = weight;
            case COLUMN_NAME -> COLUMN_NAME_JOIN_WEIGHT = weight;
            case COLUMN_VALUES -> COLUMN_VALUES_JOIN_WEIGHT = weight;
    ...
    public static void setUnionWeight(SimilarityMeasures measure, double weight) {
        switch (measure) {
            case TABLE_NAME -> TABLE_NAME_UNION_WEIGHT = weight;
            case COLUMN_NAME -> COLUMN_NAME_UNION_WEIGHT = weight;
            case COLUMN_VALUES -> COLUMN_VALUES_UNION_WEIGHT = weight;
