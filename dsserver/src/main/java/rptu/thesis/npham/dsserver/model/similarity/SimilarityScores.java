...
public class SimilarityScores {
        ...
        @Field
        private Map<String, Measures> score_map;

    public SimilarityScores(String column_id, Map<String, Measures> score_map) {
        ...
        public Map<String, Measures> getScoreMap() {
            return score_map;
        }

        public void setScoreMap(Map<String, Measures> score_map) {
            this.score_map = score_map;
        }
